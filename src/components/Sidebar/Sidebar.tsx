...
export default function Sidebar() {
  ...
  // ✅ Chưa đăng nhập -> không hiện sidebar
  if (!isLoggedIn) {
    return null;
  }
    ...
    >
      ...
      <div className="relative z-10 p-4 border-t border-white/20">
        <button
          ...
          className="flex items-center gap-3 px-4 py-2 w-full text-left text-white/80 hover:bg-white/10 rounded transition"
        >
